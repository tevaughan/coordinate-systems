...
%%
% Book metadata
\title{Coordinate Systems in Physical Space\thanks{Thanks to Neil Huffaker and
Jack Cohn for their inspiration.}}
\author[Thomas E. Vaughan]{Thomas E.\ Vaughan}
\publisher{Thomas E.\ Vaughan}
