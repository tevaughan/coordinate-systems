...
coordinate be an element of a simply ordered set,\sidenote{%
...
which is mapped continuously and in a one-to-one way onto a path.\sidenote{%
   A function takes every coordinate to a corresponding point on the same path.
   For the function to be continuous, an infinitesimal difference between
   coordinates must never produce a finite distance between the corresponding
